...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9999413025832242)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9999553492832242)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10001937467832250)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(9999413025832242)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10000500125832246)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(10002341276832251)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10002678615832252)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(9999553492832242)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10003299718832266)
...
,p_lov=>'.'||wwv_flow_imp.id(10003342263832266)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10000639456832246)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10000500125832246)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10001370248832248)
,p_event_id=>wwv_flow_imp.id(10000639456832246)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10004418968832273)
...
,p_internal_uid=>10004418968832273
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(10004883981832275)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Appearance Settings Saved.'
,p_internal_uid=>10004883981832275
);
